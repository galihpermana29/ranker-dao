        ...
        <p className="akira-outlined-white">
              ...
              <div className="d-flex flex-row">
                <div className="px-0 d-none d-lg-block">
                    ...
                    <button className="mint-btn my-4 bold-white">MINT YOUR BADGE</button>
                    </a>
                  </div>
                  <div className="px-4 d-none d-lg-block">
                    ...
                    target="_blank"
                    rel="noopener noreferrer">
                    <button className="connect-btn my-4 text-blue">CONNECT WALLET</button>
                    </a>
                  </div>
              </div>
