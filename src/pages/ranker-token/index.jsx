  ...
  return (
    <div className="container-ranker-token">
      <section className='hero d-flex align-items-center justify-content-center flex-column'>
        <img src={Coin} className="img-fluid img-coin" />
        <h1 className="ranker-text">
          $RANKER<span className="token-text">TOKEN</span>
        </h1>
        <p className="sub-text text-center">
          Level up your badge with $RANKER and unlock our exclusive NFTs, tournaments, coaching sessions and many more!
          You can get our tokens at these following site:
        </p>
      </section>
        ...
        <div className='row'>
          <div className='col-12 mb-5 mb-md-0 col-md-6 d-flex align-items-center justify-content-start flex-column'>
            ...
            {dataTokenInfo.map(item => (
              <div className='d-flex align-items-center justify-content-between w-100' key={item.id}>
                <p className={['title-text-information', item.isMarginTitle ? 'margin-title' : item.isMarginSubTitle ? 'margin-subtitle' : ''].join(' ')}>{item.title}</p>
              ...
              <tbody>
                {dataTokenAllocation.map(item => (
                  <tr className='text-col text-center' key={item.id}>
                    <td className={[item.token === 'TOKEN SALE' ? 'text-col-sale-1' : 'text-col-1'].join(' ')}>{item.token}</td>
                    {item.totalSupply && <td>{item.totalSupply}</td>}
                    {item.percentage && <td className='text-col-3'>{item.percentage}</td>}
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <tbody>
            {dataTableSale.map(item => (
              <tr key={item.id} className={['text-col'].join(' ')}>
                <td className='ps-0'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last" : "mb-0", item.id === 1 ? "text-start" : ""].join(' ')}>
          ...
          <tbody>
            {dataTableDevelopment.map(item => (
              <tr key={item.id} className={['text-col'].join(' ')}>
                <td className='ps-0'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last" : "mb-0", item.id === 1 ? "text-start" : ""].join(' ')}>
                    <p className='text-col-1-dev mb-0'>{item.titleDevelopment}</p>
                    <p className='text-col-2-dev mb-0'>{item.subtitleDevelopment}</p>
                  </div>
                </td>
                <td className='ps-0'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last" : "mb-0", item.id === 1 ? "text-start" : ""].join(' ')}>
                    <p className='text-col-1-dev mb-0'>{item.titleMarketing}</p>
                    <p className='text-col-2-dev mb-0'>{item.subtitleMarketing}</p>
                  </div>
                </td>
                <td className='ps-0'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last" : "mb-0", item.id === 1 ? "text-start" : ""].join(' ')}>
              ...
              <tr key={item.id} className={['text-col w-100'].join(' ')}>
                <td className='ps-0'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last" : "mb-0", item.id === 1 ? "text-start" : ""].join(' ')}>
                    ...
                    <p className='text-col-2-player mb-0'>{item.subtitlePlayer}</p>
                  </div>
                </td>
                <td className='ps-0'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last" : "mb-0", item.id === 1 ? "text-start" : ""].join(' ')}>
                    <p className='text-col-1-player mb-0'>{item.titleLiquidity}</p>
                    <p className='text-col-2-player mb-0'>{item.subtitleLiquidity}</p>
                  </div>
                </td>
              </tr>
            ))}
          ...
          <tbody>
            {dataTableSale.map(item => (
              <tr key={item.id} className={['text-col-mobile'].join(' ')}>
                <td className='ps-2'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last-mobile" : "mb-0", item.id === 1 ? "text-start-mobile" : ""].join(' ')}>
                    <p className='text-col-1-mobile mb-0'>{item.titleSale}</p>
                    <p className='text-col-2-mobile mb-0'>{item.subtitleSale}</p>
                  </div>
                </td>
              </tr>
            ))}
          ...
          <tbody>
            {dataTableSale.map(item => (
              <tr key={item.id} className={['text-col-mobile'].join(' ')}>
                <td className='ps-2'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last-mobile" : "mb-0", item.id === 1 ? "text-start-mobile" : ""].join(' ')}>
                    <p className='text-col-1-mobile mb-0'>{item.titlePrivate}</p>
                    <p className='text-col-2-mobile mb-0'>{item.subtitlePrivate}</p>
                  </div>
                </td>
              </tr>
            ))}
              ...
              <tr key={item.id} className={['text-col-mobile'].join(' ')}>
                <td className='ps-2'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last-mobile" : "mb-0", item.id === 1 ? "text-start-mobile" : ""].join(' ')}>
                    ...
                    <p className='text-col-2-mobile mb-0'>{item.subtitlePublic}</p>
                  </div>
                </td>
              </tr>
            ))}
          ...
          <tbody>
            {dataTableDevelopment.map(item => (
              <tr key={item.id} className={['text-col-mobile'].join(' ')}>
                <td className='ps-2'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last-mobile" : "mb-0", item.id === 1 ? "text-start-mobile" : ""].join(' ')}>
                    <p className='text-col-1-mobile mb-0'>{item.titleDevelopment}</p>
                    <p className='text-col-2-mobile mb-0'>{item.subtitleDevelopment}</p>
                  </div>
                </td>
              </tr>
            ))}
          </tbody>
        </table> <table className='table table-borderless mb-5'>
          <thead className='table-active text-center'>
            <tr className='text-row-mobile'>
              <th>MARKETING</th>
            </tr>
          ...
          <tbody>
            {dataTableDevelopment.map(item => (
              <tr key={item.id} className={['text-col-mobile'].join(' ')}>
                <td className='ps-2'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last-mobile" : "mb-0", item.id === 1 ? "text-start-mobile" : ""].join(' ')}>
                    <p className='text-col-1-mobile mb-0'>{item.titleMarketing}</p>
                    <p className='text-col-2-mobile mb-0'>{item.subtitleMarketing}</p>
                  </div>
                </td>
              </tr>
            ))}
              ...
              <tr key={item.id} className={['text-col-mobile'].join(' ')}>
                <td className='ps-2'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last-mobile" : "mb-0", item.id === 1 ? "text-start-mobile" : ""].join(' ')}>
                    ...
                    <p className='text-col-2-mobile mb-0'>{item.subtitleTeam}</p>
                  </div>
                </td>
              </tr>
            ))}
              ...
              <tr key={item.id} className={['text-col-mobile'].join(' ')}>
                <td className='ps-2'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last-mobile" : "mb-0", item.id === 1 ? "text-start-mobile" : ""].join(' ')}>
                    ...
                    <p className='text-col-2-mobile mb-0'>{item.subtitlePlayer}</p>
                  </div>
                </td>
              </tr>
            ))}
          ...
          <tbody>
            {dataTablePlayer.map(item => (
              <tr key={item.id} className={['text-col-mobile'].join(' ')}>
                <td className='ps-2'>
                  <div className={['d-flex align-items-center justify-content-between', item.id === 6 ? "text-last-mobile" : "mb-0", item.id === 1 ? "text-start-mobile" : ""].join(' ')}>
                    <p className='text-col-1-mobile mb-0'>{item.titleLiquidity}</p>
                    <p className='text-col-2-mobile mb-0'>{item.subtitleLiquidity}</p>
                  </div>
                </td>
              </tr>
            ))}
      ...
      <section className='ranker-badge'>
        <h1 className='text-ranker-badge text-center'>RANKER <span>BADGE</span></h1>
        <p className='sub-text-ranker-1'>Use your $RANKER with your badge to unlock our exclusive NFTs, tournaments, coaching sessions and many more!</p>
        <img src={rankerBadge} alt="rankerBadges" className='img-fluid img-ranker' />
        <h4 className='sub-text-ranker-2'>DONT HAVE A BADGE YET?</h4>
        <p className='sub-text-ranker-3'>Well, what are you waiting for? Get yours now!</p>
