    ...
    <section className="home-section px-4 pb-0" id={id} ref={sixthRef}>
      ...
      <div
        ...
        <p className="description-common">
          ...
          gaming against other guilds, and fellow rankers. Good luck, have fun!
        </p>
        <p className="description-common">
        ...
        <p className="description-common">
          As we grow, we will implement more Social-Fi features such as in-guild
          tournaments, and other exciting activities.
        </p>
        <HomeButton
