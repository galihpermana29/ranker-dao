  ...
  return (
    <div className="container-fluid p-0 mb-5">
      <div className="row p-0 m-0 hero-container gx-5">
        <div className="col-sm-12 col-lg-6 p-3 p-lg-5 d-flex flex-column align-items-center align-items-lg-start justify-content-start mt-3 mt-lg-5">
          <p className="akira-outlined-white">
            GET SET, PLAY, <span className="akira-fill-white">EARN</span>
          </p>
          <p className="bold-15 text-white">
