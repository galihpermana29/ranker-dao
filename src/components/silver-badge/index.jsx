...
const SilverBadge = () => {
  ...
  return (
    <>
      {
        isActive.name === 'silver' && <div className={`container-hero height-hero-silver animate__animated animate__slow ${classFadeOut}`}>
          <div className="content-wrapper my-4">
            <div className="column-left-silver">
              <h1 className='font-hero-silver'>SILVER <br /> BADGE</h1>
